...
Gem::Specification.new do |s|
  ...
  s.summary     = "A simple implementation of the Circuit Breaker pattern in Ruby"
  s.description = <<-DOC
    The library provides a mechanism for monitoring and controlling slow or unresponsive 
    remote service calls, thus preventing cascading system failures.   
  DOC
